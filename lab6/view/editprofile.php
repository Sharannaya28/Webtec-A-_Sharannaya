							...
							<table width="100%">
								<tr>
									<td colspan="2">
										...
										<input type="text" name="name" id="name" value="<?php echo $admin['Name'] ?>"><br>
										<span style="color:red;"><?php echo  $error_name;?> </span><br>
										<label for="phone">Phone:</label>
										<input type="text" name="phone" id="phone" value="<?php echo $admin['Phone'] ?>"><br>
										...
										<span style="color:red;"><?php echo  $error_gender;?> </span><br>
										<label for="address">Address : </label> 
										<input type="text" name="address" id="address" value="<?php echo $admin['Address'] ?>"><br>
